...
{
    /// <summary>
    /// Handles switching between orthographic and perspective camera modes,
    /// blending their projection matrices and delegating camera operations to the active mode.
    /// </summary>
    public class CameraModeSwitcher : MonoBehaviour, ITouchCamera
    {
        /// <summary>
        /// Singleton instance of the CameraModeSwitcher
        /// </summary>
        public static CameraModeSwitcher Instance;

        /// <summary>
        /// Reference to the orthographic camera component
        /// </summary>
        private CameraOrthoBase camOrtho;
        /// <summary>
        /// Reference to the perspective camera component
        /// </summary>
        private CameraPerspBase camPersp;
        /// <summary>
        /// Reference to the Unity Camera component
        /// </summary>
        private Camera cam;

        /// <summary>
        /// Interpolation value between orthographic (0) and perspective (1) projection matrices
        /// </summary>
        private float matrixLerp; // 0 for ortho, 1 for perspective
        /// <summary>
        /// Whether the camera is currently in orthographic mode
        /// </summary>
        private bool orthoMode = true;
        /// <summary>
        /// Cached projection matrices for orthographic and perspective modes
        /// </summary>
        private Matrix4x4 orthoMatrix, perspectiveMatrix;

        /// <summary>
        /// Spring configuration used for animating the perspective switch
        /// </summary>
        public Springs switchMove;
        /// <summary>
        /// Spring value tracking the current interpolation during perspective switch animation
        /// </summary>
        ...
        /// <summary>
        /// Unsubscribes from all camera events when this object is destroyed
        /// </summary>
        void OnDestroy()
        {
        ...
        /// <summary>
        /// Initializes the singleton, retrieves camera components, sets the default mode,
        /// and subscribes to camera events
        /// </summary>
        void Awake()
        {
            Instance = this;
        ...
        {
            Debug.Log("OnAfterSwitch orthoOn:" + orthoOn + " camPersp:" + camPersp + " camOrtho:" + camOrtho);
            if (orthoOn)
            {
        ...
        {
            orthoMode = !orthoMode;
            switchMoveLerp.Reset(switchMoveLerp.Value);
        ...
        /// <param name="allowUserInput">If true, allows user input while following the object</param>
        public void FollowGameObject(GameObject go, bool focusOnFollow, bool allowYOffsetFromGround = false, bool allowUserInput = false)
        {
            CurrentCameraMode.FollowGameObject(go, focusOnFollow, allowYOffsetFromGround, allowUserInput);
