...
namespace Gaia
{
    ...
    public class TerrainDetailOverwriteEditor : PWEditor
    {
        ...
        private void OnEnable()
        {
            ...
            m_tdo.m_gaiaDetailDistance = GaiaUtils.GetTerrainDetailShaderDistance();
            m_tdo.m_gaiaDetailFadeoutDistance = GaiaUtils.GetTerrainDetailFadeOutDistance();
        ...
        private void DetailTerrainDistance(bool helpEnabled)
        {
            ...
            m_tdo.m_unityDetailDistance = m_editorUtils.DelayedIntField("DetailDistance", m_tdo.m_unityDetailDistance, helpEnabled);
            ...
            m_tdo.m_gaiaDetailDistance = m_editorUtils.DelayedFloatField("GaiaDetailDistance", m_tdo.m_gaiaDetailDistance, helpEnabled);
            m_tdo.m_gaiaDetailFadeoutDistance = m_editorUtils.DelayedFloatField("GaiaFadeoutDistance", m_tdo.m_gaiaDetailFadeoutDistance, helpEnabled);
