...
namespace Gaia.Pipeline.HDRP
{
    ...
    public static class GaiaHDRPPipelineUtils
    {
        ...
        public static void UpdateSceneLighting(GaiaLightingProfileValues profile, UnityPipelineProfile pipelineProfile, SceneProfile lightingProfile, bool applyProfile)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        HDRPDensityVolumeController.RemoveGaiaHDRPDensityVolume();
                    }
        ...
        /// <summary>
        /// Sets the pipeline asset to the procedural worlds asset if the profile is set to change it
        /// </summary>
        /// <param name="profile"></param>
        public static void SetPipelineAsset(UnityPipelineProfile profile)
        {
            ...
            if (GaiaUtils.GetRenderPipelineAsset() == null)
            {
                try
                {
                    ...
                    GaiaUtils.SetRenderPipelineAsset(AssetDatabase.LoadAssetAtPath<RenderPipelineAsset>(GaiaUtils.GetAssetPath(pipelineAssetName + GaiaConstants.gaiaFileFormatAsset)));
        ...
        {
#if UPPipeline
            RenderPipelineAsset pipelineAsset = GaiaUtils.GetRenderPipelineAsset();
        ...
        public static void CleanUpHDRP(UnityPipelineProfile profile, GaiaSettings gaiaSettings)
        {
            ...
            {
#if HDPipeline
                HDAdditionalCameraData[] camerasData = Object.FindObjectsByType<HDAdditionalCameraData>(FindObjectsSortMode.None);
                if (camerasData != null)
                {
                ...
                HDAdditionalLightData[] lightsData = Object.FindObjectsByType<HDAdditionalLightData>(FindObjectsSortMode.None);
                if (lightsData != null)
                {
                ...
                HDAdditionalReflectionData[] reflectionsData = Object.FindObjectsByType<HDAdditionalReflectionData>(FindObjectsSortMode.None);
                ...
                GameObject waterPrefab = GaiaUtils.GetWaterObject(false);
                if (waterPrefab != null)
                {
               ...
               GaiaUtils.SetRenderPipelineAsset(null);
            ...
            {
                Debug.LogError($"Error while switching back to the built-in pipeline {e.Message}, Stack Trace: {e.StackTrace}");
            }
        }
        ...
        private static void OnCompilationFinished(object obj)
        {
            ...
            if (manager != null)
            {
                ...
                manager.m_windowRestartRequired = true;
            }
        }
        ...
        private static void SetGlobalSettingsAsset(UnityPipelineProfile profile)
        {
...
#if HDPipeline
            RenderPipelineGlobalSettings gaiaSettings = GetGaiaRenderPipelineGlobalSettings(profile);
            ...
            if (gaiaSettings != null)
            {
                ...
                if (!otherSettingsExist)
                {
                    ...
                    EditorGraphicsSettings.SetRenderPipelineGlobalSettingsAsset<UnityEngine.Rendering.HighDefinition.HDRenderPipeline>(gaiaSettings);
#else
        ...
        private static void SetHDRPEnvironmentVolume(SceneProfile sceneProfile, UnityPipelineProfile pipelineProfile, GaiaLightingProfileValues profile)
        {
            ...
            if (volumeObject != null)
            {
                ...
                if (sceneProfile.m_lightingEditSettings || profile.m_userCustomProfile)
                {
                    ...
                    ApplyHDRPGlobalIllumination(profile, sceneProfile.m_highDefinitionLightingProfile);
                }
                else
                {
        ...
        private static void SetupDefaultSceneLighting(UnityPipelineProfile profile, bool setDayInstead)
        {
            try
            {
                ...
                {
                    Volume sceneVolume = Object.FindAnyObjectByType<Volume>();
                    if (sceneVolume != null)
                    {
                    ...
                    if (EditorUtility.DisplayDialog("Setup Default HDRP Lighting", "It looks like you are starting with a new terrain and HDRP lighting is not setup in your scene. Would you like to setup default HDRP lighting suitable for editing your terrain?", "Yes", "No"))
                    {
                        ...
                        else
                        {
                            ...
                            if (sunLight != null)
                            {
                                ...
                                GaiaHDRPRuntimeUtils.SetLightIntensity(sunLight,lightData,6f);
        ...
        private static void SetupDefaultSceneLighting2019_3(UnityPipelineProfile profile)
        {
            try
            {
                ...
                if (!setDayInstead)
                {
                    ...
                    {
                        if (EditorUtility.DisplayDialog("Setup Default HDRP Lighting", "Would you like to setup default HDRP lighting suitable for editing your terrain?", "Yes", "No"))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    HDAdditionalLightData lightData = GaiaHDRPRuntimeUtils.GetHDLightData(sunLight);
                                    GaiaHDRPRuntimeUtils.SetLightUnit(sunLight, lightData, LightUnit.Lux);
                                    lightData.SetColor(GaiaUtils.GetColorFromHTML("FFECD6"));
                                    GaiaHDRPRuntimeUtils.SetLightIntensity(sunLight, lightData, 12f);
                                }
        ...
        {
            return GaiaUtils.GetLightingObject(false) != null;
        ...
        /// <summary>
        /// Sets up global illumination
        /// </summary>
        /// <param name="profile"></param>
        private static void ApplyHDRPGlobalIllumination(GaiaLightingProfileValues lightingProfile, VolumeProfile profile)
        {
            if (profile == null)
            {
                return;
            ...
            if (lightingProfile.m_useGlobalIllumination)
            {
                if (!profile.Has<GlobalIllumination>())
                {
                    profile.Add<GlobalIllumination>();
                    if (profile.TryGet(out GlobalIllumination GI))
                    {
                        ...
                        GI.depthBufferThickness.overrideState = true;
                        GI.depthBufferThickness.value = 0.01f;
                    }
            ...
            else
            {
                if (profile.Has<GlobalIllumination>())
                {
                    profile.Remove<GlobalIllumination>();
                    //nprofile.isDirty = true;
                }
            }
        }
        /// <summary>
                                ...
                                if (volumeProfile.TryGet(out GradientSky gradientSky))
                                {
                                    switch (profile.m_hDSkyType)
                                    {
                                        ...
                                        case GaiaConstants.HDSkyType.Procedural:
                                            ...
                                            //Miscellaneous
                                            //Commented out for now, since unity removed this property only in some HDRP versions, making this an unreliable property to work with.
            ...
            try
            {
                ...
                if (camera != null)
                {
                    ...
                    if (cameraData != null)
                    {
                        ...
                        camera.aperture = profile.m_cameraAperture;
        ...
        private static void SetSunSettings(GaiaLightingProfileValues profile)
        {
            try
            {
                ...
                if (light != null)
                {
                    ...
                    GaiaHDRPRuntimeUtils.SetLightIntensity(light, lightData, profile.m_hDSunIntensity);
        ...
        private static void UpdateBiomePostFX()
        {
            try
            {
                GaiaPostProcessBiome[] gaiaPostProcessBiomes = GameObject.FindObjectsByType<GaiaPostProcessBiome>(FindObjectsSortMode.None);
