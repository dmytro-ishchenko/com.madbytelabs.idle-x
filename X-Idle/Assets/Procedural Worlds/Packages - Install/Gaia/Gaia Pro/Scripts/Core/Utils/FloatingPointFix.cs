...
namespace Gaia
{
    ...
    public class FloatingPointFix : MonoBehaviour
    {
        ...
        public static FloatingPointFix Instance
        {
            ...
            {
                if (instance == null)
                    instance = (FloatingPointFix)FindAnyObjectByType(typeof(FloatingPointFix));
        ...
        {
            return position += (Vector3)TerrainLoaderManager.Instance.GetOrigin();
        }
        ...
        void LateUpdate()
        {
            ...
            {
                Vector3Double newOffset = currentPosition + TerrainLoaderManager.Instance.GetOrigin();
                TerrainLoaderManager.Instance.SetOrigin(newOffset);
