namespace Common
{
    ...
    {
        public static readonly string LIBRARY_PATH = "Assets/AssetDataBase/Resources/AssetLibrary.asset";
        public static readonly string SCENE_TEMPLATE_PATH = "Assets/AssetDataBase/Resources/SceneTemplate.asset";
